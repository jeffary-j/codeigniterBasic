...
class Frontgate extends CI_Controller {
...
*/
    ...
    public function index()
    {
        ...
        // header에 추가할 데이터
        $header_data = array();
        $header_data['css'] = array(base_url(ASSETS_CSS.'main.css'));
		...
		$footer_data['js'] = array(
			base_url(ASSETS_JS.'imagesloaded.pkgd.min.js'),
			base_url(ASSETS_JS.'jquery.colorbox-min.js'),
			base_url(ASSETS_JS.'masonry.pkgd.min.js'),
			base_url(ASSETS_JS.'main.js')
		);
        if(!empty($user_idx)){
